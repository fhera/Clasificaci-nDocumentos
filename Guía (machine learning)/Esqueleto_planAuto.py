...
# Separamos el conjunto de entrenamiento del de pruebas, pero teniendo en cuenta que los datos pueden no ser uniformes.
# Realizamos la separación de ejemplos de manera estratificada, intentando mantener la proporción:
...
# Un requisito, pues, para poder continuar es separar los conjuntos de datos cars_entrenamiento y cars_prueba en los
# valores de los atributos por un lado y la clasificación por otro.
